...
import {MatColumnDefDataSource, MatColumnDefItem} from './mat-column-def-datasource';

@Component({
  selector: 'app-mat-column-def',
  templateUrl: './mat-column-def.component.html',
...
export class MatColumnDefComponent implements AfterViewInit, OnInit {
  ...
  ngOnInit() {
    this.dataSource = new MatColumnDefDataSource();
  }
