...
import {MatHeaderRowDataSource, MatHeaderRowItem} from './mat-header-row-datasource';

@Component({
  selector: 'app-mat-header-row',
  templateUrl: './mat-header-row.component.html',
...
export class MatHeaderRowComponent implements AfterViewInit, OnInit {
  ...
  ngOnInit() {
    this.dataSource = new MatHeaderRowDataSource();
  }
